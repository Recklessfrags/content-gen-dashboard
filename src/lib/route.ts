export type HubKey = "channels" | "actions" | "overview" | "characters" | "ideas";
export type WorkspaceTab = "production" | "character" | "guidelines" | "cost";
export type AppScope =
  | { kind: "hub"; hub: HubKey }
  | { kind: "workspace"; channel: string; tab: WorkspaceTab };

export const HUB_KEYS = ["channels", "actions", "overview", "characters", "ideas"] as const satisfies readonly HubKey[];
